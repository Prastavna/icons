...
export const diamondShapeFilled = createIcon({
  ...
  category: "shape",
  variant: "filled",
  svgContent: `<path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.58a2.41 2.41 0 0 0 3.41 0l7.58-7.58a2.41 2.41 0 0 0 0-3.41L13.7 2.71a2.41 2.41 0 0 0-3.41 0z"/>`,
});
...
export const octagonShapeFilled = createIcon({
  ...
  category: "shape",
  variant: "filled",
  svgContent: `<polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"/>`,
});
...
export const pentagonShapeFilled = createIcon({
  ...
  category: "shape",
  variant: "filled",
  svgContent: `<path d="M11.92 2.58a.5.5 0 0 1 .16 0l8.65 2.81a.5.5 0 0 1 .34.47v5.32a.5.5 0 0 1-.14.35l-5.35 5.47a.5.5 0 0 1-.36.15H8.78a.5.5 0 0 1-.36-.15L3.07 11.53a.5.5 0 0 1-.14-.35V5.86a.5.5 0 0 1 .34-.47z"/>`,
});
